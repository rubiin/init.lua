return {
  {
    ...
    keys = function()
      ...
      return {
        ...
        {
          '<leader>hh',
          function() harpoon_ui:toggle_quick_menu(harpoon:list()) end,
          desc = 'Toggle menu',
        },
        {
          '<leader>ha',
        ...
        {
          '<leader>hc',
          function() harpoon_mark.clear_all() end,
          desc = 'Clear All',
        },
        {
          '<leader>hl',
          function() harpoon_ui.toggle_quick_menu() end,
          desc = 'Toggle quick menu',
        },
        {
          '<leader>hn',
          function() harpoon_ui.nav_next() end,
          desc = 'Next File',
        },
        {
          '<leader>hp',
          function() harpoon_ui.nav_prev() end,
          desc = 'Previous File',
        },
        {
          '<leader>hp',
          function() harpoon_mark.rm_file() end,
