...
## [2.9.0](https://github.com/rubiin/init.lua/compare/v2.8.0...v2.9.0) (2026-09-10)
...
* update dictionary file path for completion sources ([26a3f2d](https://github.com/rubiin/init.lua/commit/26a3f2df0b26765784c0f5e79eda9fe262f4c5db))
...
* update plugin versions and add new formatters for improved compatibility ([8abef97](https://github.com/rubiin/init.lua/commit/8abef97a01b892d6a977f18e6ba13ea30a483b5b))
* update pre-commit configuration and enhance README structure ([b57df8c](https://github.com/rubiin/init.lua/commit/b57df8ca4d782846cdd083acfb1951d20246a8a1))
* update various configurations for compatibility and cleanup ([7a4d0a5](https://github.com/rubiin/init.lua/commit/7a4d0a55566668ccc53ccc8221853b6ce21b170b))
* update yank highlight function for compatibility with nvim-0.13 ([f069061](https://github.com/rubiin/init.lua/commit/f06906126284b7d8f41564333a5d60a47055a236))
